...
public class SalesInvoiceInclussiveGSTAndInclussiveTCS extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public SalesInvoiceInclussiveGSTAndInclussiveTCS(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
        common = new Common(this.driver);
        dataFile = file;
    }
    public void salesInvoiceInclussiveGSTAndInclussiveTax() throws InterruptedException, IOException, ParseException, AWTException {
