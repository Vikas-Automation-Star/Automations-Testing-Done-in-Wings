...
public class CreateDistributions extends Masters {
    ...
    public void createDistributions() throws InterruptedException, IOException, ParseException {
        navigateToMastersWhen4Steps("Inventory","Product","Attributes","Distributions");
        Thread.sleep(1500);
        createMaster("xpath", "//TreeItem[@Name='Distributions']/TreeItem[@Name='All Distributions']");
        Thread.sleep(3000);
        inputTextWithValidation("xpath", "//Edit[@Name='New Master *']", common.getData(dataFile, "newDistribution") + common.getRandom());
