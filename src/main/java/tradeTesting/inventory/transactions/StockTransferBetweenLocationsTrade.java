...
public class StockTransferBetweenLocationsTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean isStoragebinClicked =false;

    public StockTransferBetweenLocationsTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }
    public String stockTransferBetweenLocationsTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        long start = System.nanoTime();
        navigateToMastersWhen3Steps("Inventory","Inventory","Stock Transfer Between Locations");
        ...
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Trade Gen Info:- ", generalInfoEndTime);

        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Trade Add Products:- ", addProductEnd);

        long otherInfoTabStart = System.nanoTime();
        common.clickElement("xpath","//TabItem[@Name='  OtherInfo  ']");
        otherInfo();
        long otherInfoTabEnd = System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Trade Other Info:- ", otherInfoTabEnd);
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"OpeningStock");
        ...
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Trade ended at:- ", openingStockEnd);
    ...
    public void addProduct() throws Exception {
        ...
        List<WebElement> purchaseRate = common.findWebElements("xpath", "//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Purchase Rate Row ')]");
        List<WebElement> qtyInPurchaseUnit =common.findWebElements("xpath","//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Qty In Purchase Unit Row ')]");
        ...
        for (int i = 0; i < productCode.size(); i++) {
            ...
            enterListData(purchaseRate.get(i), dataFile, "Items", "PurchaseRate", i);
