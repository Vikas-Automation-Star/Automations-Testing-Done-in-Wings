...
public class OpeningStockTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean isQtyClicked = false, isQtyInBaseUnitClicked = false;

    public OpeningStockTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public String openingStockTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        long start = System.nanoTime();
        navigateToMastersWhen3Steps("Inventory","Inventory","Opening Stock");
        ...
        EnterData("//Edit[@Name='Closing Stock Account *']",dataFile,"GeneralInformation","ClosingStockAccount");
        EnterData("//Edit[@Name='Opening Stock Control Account']",dataFile,"GeneralInformation","OpeningStockControlAccount");
        ...
        FileUtil.writeTimeLogInMinutes("Opening Stock Trade Gen Info:- ", generalInfoEndTime);

        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("Opening Stock Trade Add Products:- ", addProductEnd);

        long otherInfoTabStart = System.nanoTime();
        common.clickElement("xpath","//TabItem[@Name='  OtherInfo  ']");
        otherInfo();
        long otherInfoTabEnd = System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("Opening Stock Trade Other Info:- ", otherInfoTabEnd);

        long allocationsTabStart = System.nanoTime();
        common.clickElement("xpath", "//TabItem[contains(@Name,'Allocations')]");
        addAllocations();
        long allocationsTabEnd = System.nanoTime() - allocationsTabStart;
        FileUtil.writeTimeLogInMinutes("Opening Stock Trade Allocations:- ", allocationsTabEnd);
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"OpeningStock");
        ...
        FileUtil.writeTimeLogInMinutes("Opening Stock Trade ended at:- ", openingStockEnd);
    ...
    public void addProduct() throws Exception {
        ...
        List<WebElement> ageInDays = common.findWebElements("xpath", "//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Age In Days Row ')]");
