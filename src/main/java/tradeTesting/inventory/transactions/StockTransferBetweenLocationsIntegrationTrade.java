...
public class StockTransferBetweenLocationsIntegrationTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public StockTransferBetweenLocationsIntegrationTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }
    public String stockTransferBetweenLocationsIntegrationTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        long start = System.nanoTime();
        navigateToMastersWhen3Steps("Inventory","Inventory","Stock Transfer Between Locations Integration");
        ...
        FileUtil.writeTimeLogInMinutes(" Gen Info:- ", generalInfoEndTime);

        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Integration Trade Add Products:- ", addProductEnd);

        long otherInfoTabStart = System.nanoTime();
        common.clickElement("xpath","//TabItem[@Name='  OtherInfo  ']");
        otherInfo();
        long otherInfoTabEnd = System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Integration Trade Other Info:- ", otherInfoTabEnd);
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"OpeningStock");
        ...
        FileUtil.writeTimeLogInMinutes("Stock Transfer Between Locations Integration Trade ended at:- ", openingStockEnd);
