...
public class GodownDamagesTrade extends TransactionsBaseClass {
    ...
    public String godownDamagesTrade(String tempAPIBodyUpdate, String apiResponse, String outputFile) throws Exception {
        long start = System.nanoTime();
        navigateToMastersWhen3Steps("Inventory","Inventory","Godown Damages");
        ...
        FileUtil.writeTimeLogInMinutes("Godown Damages Trade Gen Info:- ", generalInfoEndTime);

        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("Godown Damages Trade Add Products:- ", addProductEnd);

        long otherInfoTabStart = System.nanoTime();
        common.clickElement("xpath","//TabItem[@Name='  OtherInfo  ']");
        otherInfo();
        long otherInfoTabEnd = System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("Godown Damages Trade Other Info:- ", otherInfoTabEnd);
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"OpeningStock");
        ...
        FileUtil.writeTimeLogInMinutes("Godown Damages Trade ended at:- ", openingStockEnd);
