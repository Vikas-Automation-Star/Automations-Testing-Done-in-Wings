...
public class CreateSuppliers extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateSuppliers(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void suppliers() throws InterruptedException, IOException, ParseException {
        ...
        common.clickElement("xpath", "//Button[@Name='Ok']");
        Thread.sleep(1000);
        common.sliderHandling("name", "Position", 0, 200);
