...
public class ComplexJournalEntries extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public ComplexJournalEntries(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void complexJournalEntries(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
