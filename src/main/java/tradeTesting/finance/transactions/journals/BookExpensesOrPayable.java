...
public class BookExpensesOrPayable extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public BookExpensesOrPayable(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void bookExpensesOrPayable(String receivableVoucher,String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        ...
        EnterData("//Edit[@Name='Supply Type *']", dataFile,"GeneralInformation", "PlaceOfSupply");
...
//        common.inputText("xpath", "//Edit[@Name='Supplier Bill No *']", "12" + common.getRandom());
        ...
        FileUtil.writeTimeLogInMinutes("Other Debits End Tab:- ", otherDebitsEnd);
