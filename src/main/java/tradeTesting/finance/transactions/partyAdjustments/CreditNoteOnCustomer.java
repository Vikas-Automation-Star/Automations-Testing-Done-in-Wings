...
public class CreditNoteOnCustomer extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreditNoteOnCustomer(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void creditNoteOnCustomer(String receivableVouchers,String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        ...
        common.findWebElement("xpath","//Edit[@Name='Sales Invoice No *']").sendKeys(receivableVouchers);
...
//        EnterData("//Edit[@Name='TCS Trans Nature' or @Name='TCS Trans Type']",dataFile,"GeneralInformation","");
...
//        deleteTransactionUsingVoucherNumber(newVoucherID);
    ...
    public void items() throws IOException {
        ...
        List<WebElement> creditForUnitRow  = common.findWebElements("xpath", "//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Credit For Unit Row ')]");
        for (int i = 0; i < cashTab.size(); i++) {
            ...
            enterListData(creditForUnitRow.get(i), dataFile, "Items", "CreditForUnit", i);
        }
    }
...
//        common.clickElement("xpath", "//Header[@Name='GST Amount']");
    ...
    public void billsReceivables(String receivableNumber){
        common.clickElement("xpath", "//TabItem[contains(@Name,'  BillsReceivable  ')]");
        adjustAmountInBillsReceivables(dataFile,receivableNumber);
    }
