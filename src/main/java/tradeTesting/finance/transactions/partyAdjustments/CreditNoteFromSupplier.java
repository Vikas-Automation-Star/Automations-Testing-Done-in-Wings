...
public class CreditNoteFromSupplier extends TransactionsBaseClass {
    ...
    public void creditNoteFromSupplier(String purchaseVoucher,String payableVoucher,String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
...
//        common.findWebElement("xpath","//Edit[@Name='Supplier Bill No *']").sendKeys("No"+common.getRandom());
