...
public class CreditNote extends TransactionsBaseClass {
...
//        deleteTransactionUsingVoucherNumber(newVoucherID);
    ...
    public void accounts() throws IOException, InterruptedException {
        ...
        java.util.List<WebElement> deductTDS = common.findWebElements("xpath", "//Table[@Name='Accounts']/*[contains(@Name,'Row ')]/CheckBox[starts-with(@Name,'Deduct TDS Row ')]");
