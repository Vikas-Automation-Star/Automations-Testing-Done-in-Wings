...
public class DebitNoteOnCustomer extends TransactionsBaseClass {
    ...
    public void debitNoteOnCustomer(String invoiceNumber,String payableVoucher,String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        long debitNoteOnCustomersStarts = System.nanoTime();

        navigateToMastersWhen3Steps("Finance","Party Adjustments","Debit Note on Customers");
        Thread.sleep(1000);
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"DebitNoteOnCustomer");

        deleteTransactionUsingVoucherNumber(newVoucherID);
        long debitNoteOnCustomersEnd = System.nanoTime()- debitNoteOnCustomersStarts;
        FileUtil.writeTimeLogInMinutes("Debit Note on customers End at:- ", debitNoteOnCustomersEnd );
    }
    public void items() throws IOException {
        ...
        List<WebElement> debitForUnitRow = common.findWebElements("xpath", "//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Debit For Unit Row ')]");
        for (int i = 0; i < cashTab.size(); i++) {
            ...
            enterListData(debitForUnitRow.get(i), dataFile, "Items", "DebitForUnit", i);
        }
    }
...
//        common.clickElement("xpath", "//Header[@Name='GST Amount']");
    ...
    public void InvoiceDetails() throws IOException {
        ...
        EnterData("//Edit[contains(@Name,'Invoice Value *')]",dataFile,"InvoiceDetails","InvoiceValue");
        EnterDate("//Edit[contains(@Name,'Invoice Date *')]",dataFile,"InvoiceDetails","InvoiceDate");
    }
