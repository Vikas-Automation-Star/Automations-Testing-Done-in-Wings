...
public class CashDepositsAndWithdrawalsTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CashDepositsAndWithdrawalsTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public void cashDepositsAndWithdrawalsTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
