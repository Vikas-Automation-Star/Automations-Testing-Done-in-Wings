...
public class IssuedChequesBounceTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public IssuedChequesBounceTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public String issuedChequesBounceTrade(String voucherNumber, String tempAPIBodyUpdate, String apiResponse, String outputFile) throws Exception {
        ...
        adjustAmountInPayablesAndReceivables(dataFile,"BP 2");
