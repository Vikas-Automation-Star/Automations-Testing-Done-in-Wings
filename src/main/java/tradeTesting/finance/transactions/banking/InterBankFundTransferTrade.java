...
public class InterBankFundTransferTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public InterBankFundTransferTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public void interBankFundTransferTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
