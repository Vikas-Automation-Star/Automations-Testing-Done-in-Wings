...
public class OpeningUnclearedBankEntriesTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public OpeningUnclearedBankEntriesTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public void openingUnclearedBankEntriesTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        ...
        common.clickElement("xpath","//TabItem[contains(@Name,'  UnclearedPayments  ')]");
