...
public class OpeningBalancesTrade  extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;


    public OpeningBalancesTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public String openingBalancesTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
