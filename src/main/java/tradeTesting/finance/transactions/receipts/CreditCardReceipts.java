...
public class CreditCardReceipts extends TransactionsBaseClass {
    ...
    public void creditCardReceipts(String receivableVoucher,String tempAPIBodyUpdate, String apiResponse, String outputFile) throws Exception {
        ...
        EnterData("//Edit[@Name='Swipe Machine Type *']",dataFile,"GeneralInformation","SwipeMachineType");
...
//        deleteTransactionUsingVoucherNumber(newVoucherID);
        long creditCardReceiptsEnd = System.nanoTime()- creditCardReceiptsStart;
        FileUtil.writeTimeLogInMinutes("Credit card receipts End at:- ", creditCardReceiptsEnd );
    }
    ...
    public void parties() throws IOException {
        ...
        List<WebElement>  creditCardNum= common.findWebElements("xpath", "//Table[@Name='Parties']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Credit Card No Row ')]");
        List<WebElement>  expiryDate= common.findWebElements("xpath", "//Table[@Name='Parties']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Expiry Date Row ')]");
        List<WebElement>  ApprovalNum= common.findWebElements("xpath", "//Table[@Name='Parties']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Approval No * Row ')]");
        ...
        List<WebElement> percentage = common.findWebElements("xpath", "//Table[@Name='Parties']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Percentage Row ')]");
        ...
        for (int i = 0; i < cashTab.size() ; i++) {
            ...
            enterListData(creditCardNum.get(i), dataFile, "Parties", "CreditCardNo",i);
            enterListDate(expiryDate.get(i), dataFile, "Parties", "ExpiryDate",i);
            enterListData(ApprovalNum.get(i), dataFile, "Parties", "ApprovalNo",i);
            enterListData(chargesAccRowList.get(i), dataFile, "Parties", "ChargesAccount" , i);
            enterListData(percentage.get(i), dataFile, "Parties", "Percentage" , i);
