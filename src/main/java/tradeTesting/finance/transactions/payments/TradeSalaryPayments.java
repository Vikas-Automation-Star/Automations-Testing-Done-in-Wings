...
public class TradeSalaryPayments extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public TradeSalaryPayments(WindowsDriver driver, String file) {
        super(driver);
        common = new Common( this.driver = driver);
        dataFile = file;
    }

    public String tradeSalaryPayments(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        long start = System.nanoTime();
        navigateToMastersWhen3Steps("Finance","Payments", "Trade Salary Payments");
        Thread.sleep(1000);
        ...
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments General information End:- ", generalInfoEndTime);

        //F3-Parties
        long addProductStart=System.nanoTime();
        addParties();
        long addProductEnd=System.nanoTime()-addProductStart;
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments Add Products:- ",addProductEnd);
        //cash
        ...
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments Add Cash:- ",addCashEnd);
        //other Info
        long otherInfoTabStart =System.nanoTime();
        common.clickElement("xpath", "//TabItem[contains(@Name,'  OtherInfo  ')]");
        otherInfo();
        long otherInfoTabEnd=System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments Other Info Tab:- ", otherInfoTabEnd);
        //allocations
        long allocationsTabStart=System.nanoTime();
        common.clickElement("xpath", "//TabItem[contains(@Name,'  Allocations  ')]");
        addAllocations();
        long allocationsTabEnd=System.nanoTime() - allocationsTabStart;
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments Allocations Tab:- ", allocationsTabEnd);
        //save
        transactionSave();
        ...
        FileUtil.writeTimeLogInMinutes("Trade Salary Payments ended at:- ", salesInvoiceEnd );
...
//        APIClient.validateAPIWithExcel(newVoucherID,tempAPIBodyUpdate,apiResponse,outputFile,"SalaryPayments");
    ...
    public void addParties() throws IOException {
        ...
        List<WebElement> bankAccountCodeRow = common.findWebElements("xpath", "//Table[@Name='Parties']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Bank A/c Code Row ')]");
        ...
        for (int i = 0; i < productCode.size(); i++) {
            ...
            enterListDate(bankAccountCodeRow.get(i), dataFile, "Parties", "BankAccountCode", i);
    ...
    public void cash() throws IOException {
        List<String> productCode = readExcelData(dataFile, "Cash", "AccountCode");
        System.out.println("productCodes :" + productCode.size());
        for (int i = 0; i < productCode.size(); i++) {
            addData("xpath", "//Edit[@Name='Account Code Row "+i+", Not sorted.']", dataFile, "Cash", "AccountCode", i);
        }
        List<WebElement> amount = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Amount * Row ')]");
        List<WebElement> cashAccountCode = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Cash Account Code Row ')]");
        List<WebElement> executive = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Executive Row ')]");
        List<WebElement> Department = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Department Row ')]");
        List<WebElement> Project = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Project Row ')]");
        List<WebElement> ProfitCentre = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Profit Centre Row ')]");
        List<WebElement> CostCentre = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Cost Centre Row ')]");
        List<WebElement> Comments = common.findWebElements("xpath", "//Table[@Name='Cash']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Comments Row ')]");

        for (int i = 0; i < productCode.size(); i++) {
            enterListData(amount.get(i), dataFile, "Cash", "InclusiveAmount", i);
            enterListData(cashAccountCode.get(i), dataFile, "Cash", "CashAccountCode", i);
            enterListDate(executive.get(i), dataFile, "Cash", "Executive", i);
            enterListData(Department.get(i), dataFile, "Cash", "Department", i);
            enterListData(Project.get(i), dataFile, "Cash", "Project", i);
            enterListData(ProfitCentre.get(i), dataFile, "Cash", "ProfitCentre", i);
            enterListData(CostCentre.get(i), dataFile, "Cash", "CostCentre", i);
            enterListData(Comments.get(i), dataFile, "Cash", "Comments", i);
        }
    }
