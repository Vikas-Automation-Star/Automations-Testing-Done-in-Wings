...
public class CashTransferTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CashTransferTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public String cashTransferTrade(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
