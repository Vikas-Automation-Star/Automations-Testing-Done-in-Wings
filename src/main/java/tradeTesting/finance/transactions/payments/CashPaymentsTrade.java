...
public class CashPaymentsTrade extends TransactionsBaseClass {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CashPaymentsTrade(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public void cashPaymentsTrade(String voucherNumber,String tempAPIBodyUpdate,String apiResponse) throws Exception {
