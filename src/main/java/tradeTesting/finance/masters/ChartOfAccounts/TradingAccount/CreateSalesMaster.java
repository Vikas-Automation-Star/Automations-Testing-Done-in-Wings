...
public class CreateSalesMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateSalesMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createSalesMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Sales']");
        ...
        common.clickElement("xpath","//TreeItem[@Name='Sales']");
