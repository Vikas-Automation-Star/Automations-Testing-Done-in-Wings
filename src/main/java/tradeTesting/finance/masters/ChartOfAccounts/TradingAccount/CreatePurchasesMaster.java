...
public class CreatePurchasesMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreatePurchasesMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createPurchasesMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        liabilities.click();
        liabilities.sendKeys(Keys.ARROW_RIGHT,Keys.ARROW_RIGHT,Keys.ARROW_RIGHT);
        WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Purchases']");
        ...
        saveMasterTrade();
        //inactivate
        common.clickElement("xpath","//TreeItem[@Name='Opening and Closing Stocks']");
        common.clickElement("xpath", "//TreeItem[@Name='Purchases']");
