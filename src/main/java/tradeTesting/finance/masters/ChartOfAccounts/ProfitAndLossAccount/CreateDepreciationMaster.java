...
public class CreateDepreciationMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateDepreciationMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createDepreciationMaster() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Depreciation']");
