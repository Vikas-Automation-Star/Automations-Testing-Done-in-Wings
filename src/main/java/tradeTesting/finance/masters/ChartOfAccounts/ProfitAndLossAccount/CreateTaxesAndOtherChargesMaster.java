...
public class CreateTaxesAndOtherChargesMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateTaxesAndOtherChargesMaster(WindowsDriver driver,String file){
        super(driver);
        common=new Common(this.driver=driver);
        dataFile=file;
    }

    public void createTaxesAndOtherChargesMaster() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Taxes and Other Charges']");
        ...
        common.clickElement("xpath","//TreeItem[@Name='Taxes and Other Charges']");
