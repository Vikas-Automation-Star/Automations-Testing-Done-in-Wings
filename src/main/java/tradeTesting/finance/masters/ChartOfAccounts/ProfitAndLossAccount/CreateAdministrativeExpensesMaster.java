...
public class CreateAdministrativeExpensesMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateAdministrativeExpensesMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createAdministrativeExpensesMaster() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Administrative Expenses']");
            ...
            saveMasterTrade();
            //inactivate
            common.clickElement("xpath","//TreeItem[@Name='Appropriations']");
            common.clickElement("xpath","//TreeItem[@Name='Administrative Expenses']");
