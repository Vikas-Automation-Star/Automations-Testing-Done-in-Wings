...
public class CreateFinanceExpensesMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateFinanceExpensesMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createFinanceExpensesMaster() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Finance Expenses']");
        ...
        common.clickElement("xpath","//TreeItem[@Name='Finance Expenses']");
