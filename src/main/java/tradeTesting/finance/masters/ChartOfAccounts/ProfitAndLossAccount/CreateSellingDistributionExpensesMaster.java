...
public class CreateSellingDistributionExpensesMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateSellingDistributionExpensesMaster(WindowsDriver driver,String file){
        super(driver);
        common=new Common(this.driver=driver);
        dataFile=file;
    }

    public void createSellingDistributionsMaster() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        common.clickElement("xpath","//TreeItem[@Name='Selling and Distribution Expenses']");
