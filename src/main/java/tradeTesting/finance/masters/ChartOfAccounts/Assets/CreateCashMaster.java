...
public class CreateCashMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateCashMaster(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void createCashMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
