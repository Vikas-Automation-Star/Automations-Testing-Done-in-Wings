...
public class CreateSundryDebtorsMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateSundryDebtorsMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createSundryDebtorsMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            common.clickElement("xpath", "//TreeItem[@Name='Sundry Debtors/Customers']");
