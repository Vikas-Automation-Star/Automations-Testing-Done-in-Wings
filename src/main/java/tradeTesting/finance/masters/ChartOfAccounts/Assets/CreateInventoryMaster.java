...
public class CreateInventoryMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateInventoryMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createInventoryMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Inventories']");
            ...
            common.clickElement("xpath", "//TreeItem[@Name='Inventories']");
