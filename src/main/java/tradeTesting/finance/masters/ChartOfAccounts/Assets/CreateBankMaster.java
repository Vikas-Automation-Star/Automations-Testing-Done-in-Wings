...
public class CreateBankMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateBankMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createBankMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        Thread.sleep(1200);
        common.inputText("xpath", "//Edit[@Name='BRS Bank Details']", common.getData(dataFile, "brsBankDetails"));
        ...
        common.inputText("xpath", "//Edit[@Name='Swift Code']", String.valueOf(common.getRandom()));
        ...
        inputTextWithValidation("xpath", "//Edit[@Name='Voucher Series']", String.valueOf(common.getRandom()));
        ...
        saveMasterTrade();
        //inactivate
        common.clickElement("xpath","//TreeItem[@Name='Cash']");
        common.clickElement("xpath", "//TreeItem[@Name='Bank']");
