...
public class CreateInvestmentsMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateInvestmentsMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createInvestmentsMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Investments']");
