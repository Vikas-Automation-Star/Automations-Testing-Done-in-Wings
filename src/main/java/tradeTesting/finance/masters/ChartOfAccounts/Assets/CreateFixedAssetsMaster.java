...
public class CreateFixedAssetsMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateFixedAssetsMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createFixedAssetsMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Fixed Assets']");
            ...
            saveMasterTrade();
            //inactivate
            common.clickElement("xpath","//TreeItem[@Name='Investments']");
