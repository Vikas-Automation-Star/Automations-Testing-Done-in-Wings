...
public class CreateCapitalShareHoldersFundsMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateCapitalShareHoldersFundsMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createCapitalShareHoldersMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            WebElement AllBranch = common.findWebElement("xpath", "//TreeItem[@Name='Capital/Share Holders Funds']");
            ...
            saveMasterTrade();
            //inactivate
            common.clickElement("xpath","//TreeItem[@Name='Liabilities']");
            common.clickElement("xpath", "//TreeItem[@Name='Capital/Share Holders Funds']");
