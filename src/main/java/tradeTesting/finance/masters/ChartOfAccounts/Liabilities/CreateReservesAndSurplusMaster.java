...
public class CreateReservesAndSurplusMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateReservesAndSurplusMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createReservesSurplusMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        common.clickElement("xpath", "//TreeItem[@Name='Reserves and Surplus']");
