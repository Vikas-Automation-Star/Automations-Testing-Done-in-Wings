...
public class CreateSundryCreditorsSuppliersMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateSundryCreditorsSuppliersMaster(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void createSundryCreditorsMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        common.clickElement("xpath", "//TreeItem[@Name='Sundry Creditors/Suppliers']");
