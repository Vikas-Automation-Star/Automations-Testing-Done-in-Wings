...
public class CreateUnSecuredLoansMaster extends Masters {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateUnSecuredLoansMaster(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void createUnsecuredLoansMasterTrade() throws InterruptedException, IOException, ParseException, AWTException {
