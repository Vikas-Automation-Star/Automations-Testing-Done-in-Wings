...
public class CreateSwipeTypeMaster extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateSwipeTypeMaster(WindowsDriver driver, String file) {
        super(driver);
        common = new Common(this.driver = driver);
        dataFile = file;
    }

    public void createSwipeTypeMaster() throws InterruptedException, IOException, ParseException {
        navigateToMastersWhen3Steps("Finance","Credit Cards","Swipe Types");
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        common.inputText("xpath", "//Edit[@Name='New Swipe Type *']", common.getData(dataFile, "accountName") + common.getRandom());
        Thread.sleep(1000);
        ...
        //inactive
        common.clickElement("xpath","//TreeItem[@Name='Swipe Types']");
        common.clickElement("xpath","//TreeItem[@Name='All Swipe Types']");
        List<WebElement> listItems = common.findWebElements("xpath", "//Pane[@Name='Swipe Types']/Pane/Pane/Pane/Pane/Pane/List/*");
