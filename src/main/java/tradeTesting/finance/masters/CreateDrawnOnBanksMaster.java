...
public class CreateDrawnOnBanksMaster extends Masters{
        WindowsDriver driver;
        Common common;
        String dataFile;

        public CreateDrawnOnBanksMaster(WindowsDriver driver, String file) {
            super(driver);
            common = new Common(this.driver = driver);
            dataFile = file;
        }

        public void createDrawnOnBanksMaster() throws InterruptedException, IOException, ParseException, AWTException {
            navigateToMastersWhen2Steps("Finance","Drawn On Banks");
            Thread.sleep(1000);
            ...
            //inactive
            common.clickElement("xpath","//TreeItem[@Name='Drawn On Banks']");
            common.clickElement("xpath","//TreeItem[@Name='All Drawn On Banks']");
            List<WebElement> listItems = common.findWebElements("xpath", "//Pane[@Name='Drawn On Banks']/Pane/Pane/Pane/Pane/Pane/List/*");
