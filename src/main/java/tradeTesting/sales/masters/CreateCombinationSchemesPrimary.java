...
public class CreateCombinationSchemesPrimary extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateCombinationSchemesPrimary(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void createCombinationSchemesPrimary() throws InterruptedException, IOException, ParseException {
        navigateToMastersWhen3Steps("Sales","Promotion","Combination Schemes - Primary");
        Thread.sleep(1500);
        createMaster("xpath", "//TreeItem[@Name='Combination Schemes - Primary']/TreeItem[@Name='All Combination Scemes - Primary']");
        Thread.sleep(3000);
        inputTextWithValidation("xpath", "//Edit[@Name='New Master *']", common.getData(dataFile, "newCombinationSchemePrimary") + common.getRandom());
        ...
        common.clickElement("xpath","//Button[@Name='OK']");
        common.clickElement("xpath","//Text[@Name='Combination Slabs']/following-sibling::Button[@Name='...']");
...
//        common.clickElement("xpath","//CheckBox[@Name='Same Item Free Row 0']");
        ...
        common.clickElement("xpath","//TreeItem[@Name='Combination Schemes - Primary']");
        common.clickElement("xpath","//TreeItem[@Name='All Combination Scemes - Primary']");
        ...
        for (WebElement v:fetchMasters){
            if (v.getText().equals(master)) {
                ...
                closeMaster("Combination Schemes - Primary");
                break;
            }
        }
