...
public class CreateCombinationSchemes extends Masters {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public CreateCombinationSchemes(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void createCombinationSchemes() throws InterruptedException, IOException, ParseException {
        navigateToMastersWhen3Steps("Sales","Promotion","Combination Schemes");
        Thread.sleep(1500);
        createMaster("xpath", "//TreeItem[@Name='Combination Schemes']/TreeItem[@Name='All Combination Schemes']");
        Thread.sleep(3000);
        inputTextWithValidation("xpath", "//Edit[@Name='New Master *']", common.getData(dataFile, "newCombinationScheme") + common.getRandom());
...
//        common.clickElement("xpath","//CheckBox[@Name='Same Item Free Row 0']");
        ...
        common.clickElement("xpath","//Button[@Name='Ok']");
        common.clickElement("xpath","//Button[@Name='Ok']");
        common.clickElement("xpath","//Text[@Name='Applicables Products']/following-sibling::Button[@Name='...']");
        common.clickElement("xpath","//Button[@Name='Ok']");

        saveAfterMasterCreate();
        validateMastersAndInactive("Combination Schemes",master);
        Thread.sleep(1000);
    }
}
