...
public class CashReceiptsMobile extends BaseHelper{
    String dataFile;
    public CashReceiptsMobile(WebDriver driver, String file){
        super(driver);
        dataFile=file;
    }

    public void cashReceipts() throws InterruptedException, IOException, ParseException {
        findWebElementWithTime("xpath","//*[text()='Explorer']",10).click();
        Thread.sleep(3000);
        findWebElementInMobile("xpath","(//ion-label[@class='sc-ion-label-ios-h sc-ion-label-ios-s ios'][normalize-space()='Cash Receipts'])[2]").click();
        Thread.sleep(2000);
