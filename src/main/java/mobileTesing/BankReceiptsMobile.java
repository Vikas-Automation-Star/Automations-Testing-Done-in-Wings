...
public class BankReceiptsMobile extends BaseHelper{
    String dataFile;
    public BankReceiptsMobile(WebDriver driver, String file){
        super(driver);
        dataFile=file;
    }

    public void bankReceipts() throws InterruptedException, IOException, ParseException {
        findWebElementWithTime("xpath","//*[text()='Explorer']",10).click();
        Thread.sleep(2000);
        findWebElementInMobile("xpath","(//ion-label[@class='sc-ion-label-ios-h sc-ion-label-ios-s ios'][normalize-space()='Bank Receipts'])[2]").click();
        Thread.sleep(2000);
        findWebElementInMobile("xpath","//div[@class='transaction-tables']//div[1]//ion-list[1]//ion-list-header[1]//ion-button[1]").click();
        inputText("xpath","//*[contains(@placeholder,'Enter Date')]", Time.getFormattedFutureDate(0));
        Thread.sleep(1500);
        ...
        for (int i = 0; i < Integer.parseInt(getData(dataFile, "parties", "partiesRows")); i++) {
            ...
            Thread.sleep(1000);
            findWebElementInMobile("cssselector","body > app-root:nth-child(1) > ion-app:nth-child(1) > ion-modal:nth-child(2) > div:nth-child(1) > ion-header:nth-child(1) > ion-toolbar:nth-child(1) > ion-buttons:nth-child(3) > ion-button:nth-child(1)").click();
            Thread.sleep(1000);
            ...
            Thread.sleep(500);
            addData("xpath", "//*[@placeholder='Enter Amount']", dataFile, "parties", "partyAmount", i);
            inputText("xpath","//*[contains(@placeholder,'Enter Cheque/EFT No')]",getData(dataFile,"parties","EFT/NO"));
            inputText("xpath","//*[contains(@placeholder,'Enter Cheque Date')]", Time.getFormattedFutureDate(0));
            ...
            addData("xpath", "//*[@placeholder='Enter Charges']", dataFile, "parties", "charges", i);
            Thread.sleep(500);
            addData("xpath","//*[contains(@placeholder,'Enter Comments')]",dataFile,"parties","comments",i);
            Thread.sleep(1500);
