...
public class IntraStateIncludingGST_14 extends Transaction {
    ...
    public IntraStateIncludingGST_14(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void testCase14() throws InterruptedException, IOException, ParseException, AWTException {
