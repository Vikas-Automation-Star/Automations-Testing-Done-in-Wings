...
public class InterStateUnRegCustIncludingGSTIncludingTCS_26 extends Transaction {
        ...
        public InterStateUnRegCustIncludingGSTIncludingTCS_26(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void testCase26() throws InterruptedException, IOException, ParseException, AWTException {
