...
public class IntraStateIncludingGSTIncludingTCSIncludingCD_17 extends Transaction {
    ...
    public IntraStateIncludingGSTIncludingTCSIncludingCD_17(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
