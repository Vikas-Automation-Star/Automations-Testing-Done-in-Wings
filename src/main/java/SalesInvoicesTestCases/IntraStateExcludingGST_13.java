...
public class IntraStateExcludingGST_13 extends Transaction {
    ...
    public IntraStateExcludingGST_13(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void testCase13() throws InterruptedException, IOException, ParseException, AWTException {
