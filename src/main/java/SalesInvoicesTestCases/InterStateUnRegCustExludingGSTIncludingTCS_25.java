...
public class InterStateUnRegCustExludingGSTIncludingTCS_25 extends Transaction {
        WindowsDriver driver;
        Common common;
        String dataFile;
        double mrp, quantity, grossAmount, unitRate, voucherDiscountValue, partyDiscountValue, netAmount, grossMinusDiscount;

        public InterStateUnRegCustExludingGSTIncludingTCS_25(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void testCase25() throws InterruptedException, IOException, ParseException, AWTException {
