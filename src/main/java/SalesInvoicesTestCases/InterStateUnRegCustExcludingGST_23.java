...
public class InterStateUnRegCustExcludingGST_23 extends Transaction {
        WindowsDriver driver;
        Common common;
        String dataFile;
        double mrp, quantity, grossAmount, unitRate, voucherDiscountValue, partyDiscountValue, netAmount, grossMinusDiscount;

        public InterStateUnRegCustExcludingGST_23(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void testCase23() throws InterruptedException, IOException, ParseException, AWTException {
