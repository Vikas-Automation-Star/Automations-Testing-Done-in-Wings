...
public class InterStateIncludingGSTIncludingTCSIncludingCD_05 extends Transaction {
    ...
    public InterStateIncludingGSTIncludingTCSIncludingCD_05(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void interStateIncludingGSTIncludingTCSIncludingCD_05() throws InterruptedException, IOException, ParseException, AWTException {
...
//        super.validateElements("xpath","//Edit[@Name='Invoice Type']", common.getData(dataFile,"invoice"));
        ...
        chargesAndDeductionsCalculations(dataFile, "type", "chargesAccCode", "charges", "chargesRowCount");
