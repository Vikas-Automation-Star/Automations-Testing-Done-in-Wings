...
public class DraftInvoiceDesigns extends Masters {

        WindowsDriver driver;
        Common common;
        String filepath;

        public DraftInvoiceDesigns(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void draftInvoiceDesigns() throws InterruptedException, IOException, ParseException {
            ...
            createMaster("xpath", "//TreeItem[@Name='Draft Invoice Designs']/TreeItem[@Name='All Draft Invoice Designs']");
            Thread.sleep(2000);
            common.inputText("xpath", "//Edit[@Name='New Draft Invoice Design *']", common.getData(filepath, "newAccount") + common.getRandom());
