...
public class MasterConfig {
    ...
    public void movingNodeAsSubNode() throws InterruptedException, IOException, ParseException {
        Thread.sleep(2000);
        common.clickElement("name", "Sales");
        common.clickElement("name", "Customers");
        Thread.sleep(1500);
        ...
        for (int i = 0; i < listElements3.size(); i++) {
            ...
            if (element3.getText().equals(moveToSubNode)) {
                ...
                common.clickElement("name", "Customers");
                common.clickElement("xpath", "//TreeItem[@Name='Customers']");
                WebElement moveToRight =common.findWebElement("Xpath","//TreeItem[@Name='Customers']");
                moveToRight.sendKeys(Keys.ARROW_RIGHT,Keys.ARROW_RIGHT);
//                mooveToRight.getText()
//                common.inputText("xpath","//Edit[@Name='New Name']", common.getData(dataFile,"rename"));
//                common.clickElement("xpath","//Button[@Name='OK']");
//                common.clickElement("xpath","//Window/Button[@Name='OK']");
//                System.out.println("Node is Renamed");
