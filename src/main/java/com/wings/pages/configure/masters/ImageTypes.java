...
public class ImageTypes extends Masters {

        WindowsDriver driver;
        Common common;
        String filepath;

        public ImageTypes(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void imageTypes() throws InterruptedException, IOException, ParseException {
            ...
            createMaster("xpath", "//TreeItem[@Name='Image Types']/TreeItem[@Name='All Image Types']");
            Thread.sleep(2000);
            common.inputText("xpath", "//Edit[@Name='New Image Type *']", common.getData(filepath, "newAccount") + common.getRandom());
