...
public class ProductSeasons extends Masters {

        WindowsDriver driver;
        Common common;
        String filepath;

        public ProductSeasons(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void productSeasons() throws InterruptedException, IOException, ParseException {
            ...
            createMaster("xpath", "//TreeItem[@Name='Product Seasons']/TreeItem[@Name='All Product Seasons']");
            Thread.sleep(2000);
            common.inputText("xpath", "//Edit[@Name='New Product Season *']", common.getData(filepath, "newAccount") + common.getRandom());
