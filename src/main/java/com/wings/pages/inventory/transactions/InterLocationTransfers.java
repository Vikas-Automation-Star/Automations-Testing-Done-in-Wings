...
public class InterLocationTransfers extends TransactionsBaseClass {
    ...
    public String locationTransfer() throws InterruptedException, AWTException, IOException, ParseException {
        ...
        FileUtil.writeTimeLogInMinutes("Inter Location Transfers ended at:- ", deliveriesEnd);
        String prefix = newVoucherID.replaceAll("\\d", "");
        String number = newVoucherID.replaceAll("\\D", "");
        Thread.sleep(2000);
        long ioFIlesStart =System.nanoTime()-start;
        FileUtil.writeTimeLogInMinutes("Inter Location Transfers IO files: ", ioFIlesStart);
        ...
        FileUtil.writeTimeLogInMinutes("Inter Location Transfers IO files end: ", ioFIlesEnd);
