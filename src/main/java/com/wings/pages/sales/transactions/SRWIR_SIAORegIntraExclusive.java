...
public class SRWIR_SIAORegIntraExclusive extends Transaction {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public SRWIR_SIAORegIntraExclusive(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void regExclusiveIntraInvoiceRef_SIAO(String salesInvoiceVoucher) throws InterruptedException, IOException, ParseException, AWTException {
            ...
            enterInput("xpath", "//Edit[@Name='Branch *']", dataFile, "srwirSalesInvoiceAgnstOrders", "branch");
            enterInput("xpath", "//Edit[@Name='Location *']", dataFile, "srwirSalesInvoiceAgnstOrders", "location");
...
//        Assert.assertEquals(common.getText("xpath", "//Edit[@Name='Location *']"), common.getData(dataFile, "salesReturn", "location"), "Location is not validated");
            ...
            enterInput("xpath","//Edit[@Name='Sales Return A/c Code']",dataFile,"srwirSalesInvoiceAgnstOrders","salesReturnAccountCode");
...
//            generalInfoSliderHandle(250);
            enterInput("xpath", "//Edit[@Name='TCS Trans Nature']", dataFile,"srwirSalesInvoiceAgnstOrders", "tcsTransactionNature");
...
//                        freeQuantity.sendKeys(pendingFreeQuantity, Keys.TAB);
            ...
            Thread.sleep(1500);
            verifyReport(newVoucherId,dataFile,"srwirSalesInvoiceAgnstOrders");
            ...
            FileUtil.writeTimeLog("sales return WIR",duration/1000000000);
        }
    }