...
public class SRWIR_SIADUnRegIntraExclusive extends Transaction{
        WindowsDriver driver;
        Common common;
        String dataFile;

        public SRWIR_SIADUnRegIntraExclusive(WindowsDriver driver,String file){
            super(driver);
            this.driver=driver;
        ...
        public void unRegExclusiveIntraInvoiceRef_SIAD(String salesInvoiceVoucher) throws InterruptedException, IOException, ParseException, AWTException {
            long start = System.nanoTime();
            System.out.println("SRWIR_SIAD startTime executed in :"+start);
            Thread.sleep(100);
...
//                        freeQuantity.sendKeys(pendingFreeQuantity, Keys.TAB);
            ...
            FileUtil.writeTimeLog("SRWIR_SIAD",duration/1000000000);
        }
    }