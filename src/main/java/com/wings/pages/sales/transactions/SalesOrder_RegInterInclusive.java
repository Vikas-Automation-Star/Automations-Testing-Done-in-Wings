...
public class SalesOrder_RegInterInclusive extends Transaction {
        ...
        public SalesOrder_RegInterInclusive(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public String[] interInclusiveReg() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        public void addProduct(int i) throws InterruptedException, IOException, ParseException, AWTException {
            ...
            Assert.assertEquals(common.getText("xpath", "//Edit[@Name='GST Amount Row " + i + ", Not sorted.']"), common.getData(dataFile,"SalesOrder", "expectedGStInclusive" +i), "GST Amount mismatch");
