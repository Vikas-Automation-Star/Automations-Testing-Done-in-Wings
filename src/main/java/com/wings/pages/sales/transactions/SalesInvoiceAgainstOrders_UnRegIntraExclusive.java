...
public class SalesInvoiceAgainstOrders_UnRegIntraExclusive extends Transaction{
        WindowsDriver driver;
        Common common;
        String dataFile;

        public SalesInvoiceAgainstOrders_UnRegIntraExclusive(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public String[] intraExclusiveUnregSIAO(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
...
//            Assert.assertEquals(common.getText("xpath", "//Edit[@Name='Party Account *']"), common.getData(dataFile, "salesInvoiceAgainstOrders", "partyName"));
            ...
            FileUtil.writeTimeLog("PurchaseEnquiries",duration/1000000000);
