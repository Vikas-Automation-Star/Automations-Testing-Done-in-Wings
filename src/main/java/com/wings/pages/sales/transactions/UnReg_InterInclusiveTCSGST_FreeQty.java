...
//            Assert.assertEquals(common.findWebElement("xpath","//Edit[@AutomationId='FreeQuantity']").getText(),freeQuantity,"Free Quantity mismatch in Items tab");
        ...
        public void addProduct(int i) throws InterruptedException, IOException, ParseException, AWTException {
            ...
            if (gstTransType.equalsIgnoreCase("Inter State Sales to Unregistered Dealers")) {
            ...
            } else if (gstTransType.equalsIgnoreCase("Intra State Sales to Unregistered Dealers")) {
