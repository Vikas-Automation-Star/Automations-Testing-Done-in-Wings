...
public class SalesQuotationCancellaton extends TransactionsBaseClass {
    ...
    public String salesQuotationCancelltion(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
...
//        System.out.println("sales quotation Cancellation startTime executed in :"+start);
        ...
        FileUtil.writeTimeLogInMinutes("SQC General Information End:- ", generalInfoEndTime);

        //items
        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("SQC Add Products:- ", addProductEnd);

        long otherInfoTabStart = System.nanoTime();
        otherInfo();
        long otherInfoTabEnd = System.nanoTime() - otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("SQC Other Info:- ", otherInfoTabEnd);

        long additionalInfoTabStart = System.nanoTime();
        additionalInformation();
        long additionalInfoTabEnd = System.nanoTime() - additionalInfoTabStart;
        FileUtil.writeTimeLogInMinutes("SQC Additional Information:- ", additionalInfoTabEnd);
