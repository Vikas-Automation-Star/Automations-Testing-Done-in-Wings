...
public class SalesInvoiceFQ_RegIntraExclusive extends TransactionsBaseClass {
    ...
    public String salesReturnWithInvoiceReference() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        FileUtil.writeTimeLogInMinutes("Terms and Conditions Tab:- ", addShippingAddressEnd);
    ...
    public void addPendingProducts() throws InterruptedException, IOException {
...
//            common.sliderHandling("xpath", "//Table[@Name='Items']/*/Thumb[@Name='Position']", 700, 0);
    ...
    public void AddInvoiceDetails(){
        EnterData("//Edit[@Name='Invoice Value *']",dataFile,"","");
        EnterData("//Edit[@Name='Invoice Date *']",dataFile,"","");
    }
    ...
    public void addShippingAddress() throws IOException {
        List<WebElement> shippingAddress=common.findWebElements("xpath","//Pane[contains(@Name,'Shipping Address  ')]//Pane/Edit/*");
        System.out.println("Shipping Address :"+shippingAddress.size());
        for (int i = 0; i < shippingAddress.size() ; i++) {
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","PartyAccount",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","GSTIN",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","Address1",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","Address2",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","Address3",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","City",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","State",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","Country",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","Zip",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","TelephoneNo",i);
            enterListData(shippingAddress.get(i),dataFile,"ShippingAddress","MobileNo",i);
        }
    }
