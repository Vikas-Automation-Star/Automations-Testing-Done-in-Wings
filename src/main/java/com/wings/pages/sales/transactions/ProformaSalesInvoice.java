...
public class ProformaSalesInvoice extends TransactionsBaseClass {
    ...
    public String proformaSalesInvoice(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        ...
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Add Products:- ",addProductEnd);
        ...
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Charges and Deductions:- ",chargesDeductionsEnd);
        //other charges
        long otherChargesStart =System.nanoTime();
        addOtherCharges();
        long otherChargesEnd=System.nanoTime()- otherChargesStart;
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Other Charges:- ",otherChargesEnd);
        //Other info
        long otherInfoTabStart =System.nanoTime();
        otherInfo();
        long otherInfoTabEnd =System.nanoTime()- otherInfoTabStart;
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Other Info Tab:- ", otherInfoTabEnd);
        //additional Info
        long additionalInfoTabStart =System.nanoTime();
        additionalInformation();
        long additionalInfoTabEnd =System.nanoTime()- additionalInfoTabStart;
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Additional Info Tab:- ", additionalInfoTabEnd);
        //shipping Address
        long shippingAddressTabStart=System.nanoTime();
        shippingAddress();
        long shippingAddressTabEnd=System.nanoTime()-shippingAddressTabStart;
        FileUtil.writeTimeLogInMinutes("Proforma sales Invoice Shipping address tab: ",shippingAddressTabEnd);
        //terms and Cond
        long termsConditionsTabStart =System.nanoTime();
        termsAndCondition();
        long termsConditionsTabEnd =System.nanoTime()- termsConditionsTabStart;
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Terms and Conditions Tab:- ", termsConditionsTabEnd);
        //allocations
        long allocationsTabStart=System.nanoTime();
        addAllocations();
        long allocationsTabEnd=System.nanoTime() - allocationsTabStart;
        FileUtil.writeTimeLogInMinutes("proforma Sales Invoice Allocations Tab:- ", allocationsTabEnd);
        //save
        transactionSave();
