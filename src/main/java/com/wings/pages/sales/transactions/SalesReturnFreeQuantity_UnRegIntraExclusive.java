...
public class SalesReturnFreeQuantity_UnRegIntraExclusive extends Transaction{
        ...
        public SalesReturnFreeQuantity_UnRegIntraExclusive(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public void UnRegIntraExclusiveSalesReturn(String voucherID) throws InterruptedException, IOException, ParseException, AWTException {
