...
public class SalesOrders extends Transaction {
        ...
        public String salesOrders() throws InterruptedException, IOException, ParseException, AWTException {
            ...
            System.out.println("Sales Orders startTime executed in :"+start);
           ...
           //F3-Items
            ...
            enterChargesAndDeductions(dataFile,"SalesOrder");
            enterOtherCharges(dataFile,"SalesOrder");
            //collections
            enterCash(dataFile,"SalesOrder");
            enterChequesInSO(dataFile,"SalesOrder");
            enterPostDatedChequesInSO(dataFile,"SalesOrder");
            enterChequesPDCInSO(dataFile,"SalesOrder");
            enterCreditCard(dataFile,"SalesOrder");
            ...
            //terms
            scrollRight(8);
            termsAndConditions(dataFile,"SalesOrder");
            //save
            transactionSave();
            ...
            FileUtil.writeTimeLog("Sales Orders",duration/1000000000);
        ...
        public void addProduct(int i) throws InterruptedException, IOException, ParseException, AWTException {
            ...
            Assert.assertEquals(common.getText("xpath", "//Edit[@Name='IGST Row " + i + ", Not sorted.']"), common.getData(dataFile, "SalesOrder","igstAmount" + i),"IGST mismatch");
