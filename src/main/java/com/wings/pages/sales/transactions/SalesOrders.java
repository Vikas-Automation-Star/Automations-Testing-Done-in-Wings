...
public class SalesOrders extends TransactionsBaseClass {
    ...
    public String salesOrders() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        //validate summary
        assertSummaaryFields(summary,"Quantity *", common.getData(dataFile,"salesOrder","expectedQuantityInSummary"));
        assertSummaaryFields(summary,"Quantity In SKU *", common.getData(dataFile,"salesOrder","expectedQuantityInSKUSummary"));
        assertSummaaryFields(summary,"Gross Amount", common.getData(dataFile,"salesOrder","expectedGrossAmount"));
        assertSummaaryFields(summary,"Discount1", common.getData(dataFile,"salesOrder","expectedDiscount1"));
        assertSummaaryFields(summary,"Discount2", common.getData(dataFile,"salesOrder","expectedDiscount2"));
        assertSummaaryFields(summary,"Discount3", common.getData(dataFile,"salesOrder","expectedDiscount3"));
        assertSummaaryFields(summary,"Discount", common.getData(dataFile,"salesOrder","expectedDiscount"));
        assertSummaaryFields(summary,"Gross - Disc", common.getData(dataFile,"salesOrder","expectedGrossMinusDiscount"));
        assertSummaaryFields(summary,"IGST", common.getData(dataFile,"salesOrder","expectedIGST"));
        assertSummaaryFields(summary,"CESS", common.getData(dataFile,"salesOrder","expectedCESS"));
        assertSummaaryFields(summary,"Net Amount", common.getData(dataFile,"salesOrder","expectedNetAmount"));
        assertSummaaryFields(summary,"Charges", common.getData(dataFile,"salesOrder","expectedCharges"));
        assertSummaaryFields(summary,"Deductions", common.getData(dataFile,"salesOrder","expectedDeductions"));
        assertSummaaryFields(summary,"Other Charges", common.getData(dataFile,"salesOrder","expectedOtherCharges"));
        assertSummaaryFields(summary,"Other Charges IGST", common.getData(dataFile,"salesOrder","expectedOtherChargesIGST"));
        assertSummaaryFields(summary,"Other Charges CESS", common.getData(dataFile,"salesOrder","expectedOtherChargesCESS"));
        assertSummaaryFields(summary,"Total Value", common.getData(dataFile,"salesOrder","expectedTotalValue"));
        assertSummaaryFields(summary,"Cash", common.getData(dataFile,"salesOrder","expectedCash"));
        assertSummaaryFields(summary,"Cheques", common.getData(dataFile,"salesOrder","expectedCheques"));
        assertSummaaryFields(summary,"Post Dated Cheques", common.getData(dataFile,"salesOrder","expectedPostDatedCheques"));
        assertSummaaryFields(summary,"Cheques [PDC]", common.getData(dataFile,"salesOrder","expectedChequesPDC"));
        assertSummaaryFields(summary,"Credit Card", common.getData(dataFile,"salesOrder","expectedCreditCard"));
        assertSummaaryFields(summary,"Payment Received", common.getData(dataFile,"salesOrder","expectedReceivableAmount"));
