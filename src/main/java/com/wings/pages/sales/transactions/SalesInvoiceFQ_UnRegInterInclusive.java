...
public class SalesInvoiceFQ_UnRegInterInclusive extends Transaction {
    ...
    public String interStateInclusiveTCSGST_FreeQty() throws InterruptedException, IOException, ParseException, AWTException {
    ...
    public void addProduct(int i) throws InterruptedException, IOException, ParseException, AWTException {
        ...
        Assert.assertEquals(common.getText("xpath", "//Edit[@Name='GST Amount Row " + i + ", Not sorted.']"), common.getData(dataFile,"salesInvoice", "expectedGStInclusive" +i), "GST Amount mismatch");
