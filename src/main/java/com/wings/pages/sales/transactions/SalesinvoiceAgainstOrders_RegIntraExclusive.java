...
public class SalesinvoiceAgainstOrders_RegIntraExclusive extends Transaction {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public SalesinvoiceAgainstOrders_RegIntraExclusive(WindowsDriver driver, String file) {
            super(driver);
            this.driver = driver;
        ...
        public String[] intraExclusiveRegSIAO(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
...
//            Assert.assertEquals(common.getText("xpath", "//Edit[@Name='Party Account *']"), common.getData(dataFile, "salesInvoiceAgainstOrders", "partyName"));
            ...
            FileUtil.writeTimeLog("SIAO",duration/1000000000);
