...
public class SRTWIR_RegIntraExclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public SRTWIR_RegIntraExclusive(WindowsDriver driver,String file){
        super(driver);
        this.driver=driver;
    ...
    public void RegExclusiveInvoiceReference(String salesInvoiceVoucher) throws InterruptedException, IOException, ParseException, AWTException {
