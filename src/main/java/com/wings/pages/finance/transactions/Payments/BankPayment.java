...
public class BankPayment extends TransactionsBaseClass {
    ...
    public String bankPayment() throws InterruptedException, IOException, ParseException {
        ...
        FileUtil.writeTimeLogInMinutes("Bank Payment ended at:- ", salesInvoiceEnd );
        //IO
        ...
        FileUtil.writeTimeLogInMinutes("Bank Payment IO files ended at:- ", ioFilesEnd );
