...
public class ReceivedCheckBounce extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public ReceivedCheckBounce(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void receivedCheckBounce() throws InterruptedException, IOException, ParseException {
        ...
        super.closeTransaction("Received Cheques Bounce");
        Thread.sleep(2000);
