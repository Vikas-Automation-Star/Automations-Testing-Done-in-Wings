...
public class MiscellaneousAssestsMaster {
    ...
    public MiscellaneousAssestsMaster(WindowsDriver driver, String file) {
        this.driver = driver;
        common = new Common(this.driver);
        dataFile = file;
    }

    public void miscellaneousAssests() throws InterruptedException, IOException, ParseException, AWTException {
