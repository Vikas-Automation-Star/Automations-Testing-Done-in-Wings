...
public class InvestmentsMaster {
    WindowsDriver driver;
    Common common;
    String dataFile;


    public InvestmentsMaster(WindowsDriver driver, String file) {
        this.driver = driver;
        common = new Common(this.driver);
        dataFile = file;
    }

    public void investments() throws InterruptedException, IOException, ParseException, AWTException {
