...
public class FinanceExpensesMaster {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public FinanceExpensesMaster(WindowsDriver driver, String file) {
            this.driver = driver;
            common = new Common(this.driver);
            dataFile = file;
        }

        public void financeExpenses() throws InterruptedException, IOException, ParseException, AWTException {
