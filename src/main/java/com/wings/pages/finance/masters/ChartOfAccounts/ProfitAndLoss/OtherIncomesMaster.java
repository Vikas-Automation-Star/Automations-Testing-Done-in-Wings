...
public class OtherIncomesMaster {
        WindowsDriver driver;
        Common common;
        String dataFile;

        public OtherIncomesMaster(WindowsDriver driver, String file) {
            this.driver = driver;
            common = new Common(this.driver);
            dataFile = file;
        }

        public void otherIncomes() throws InterruptedException, IOException, ParseException, AWTException {
