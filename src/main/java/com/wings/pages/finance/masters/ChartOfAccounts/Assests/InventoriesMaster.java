...
public class InventoriesMaster {
    WindowsDriver driver;
    Common common;
    String dataFile;


    public InventoriesMaster(WindowsDriver driver, String file) {
        this.driver = driver;
        common = new Common(this.driver);
        dataFile = file;
    }

    public void inventories() throws InterruptedException, IOException, ParseException, AWTException {
        ...
        assets.click();
        assets.sendKeys(Keys.ARROW_RIGHT, Keys.ARROW_RIGHT, Keys.ARROW_RIGHT, Keys.ARROW_RIGHT, Keys.ARROW_RIGHT, Keys.DOWN, Keys.DOWN);
