...
public class PurchaseVoucher_UnRegIntraRCMExclusive extends Transaction {
    ...
    public PurchaseVoucher_UnRegIntraRCMExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String purchaseVoucher_UnRegIntraRCMExclusive() throws InterruptedException, IOException, ParseException, AWTException {
