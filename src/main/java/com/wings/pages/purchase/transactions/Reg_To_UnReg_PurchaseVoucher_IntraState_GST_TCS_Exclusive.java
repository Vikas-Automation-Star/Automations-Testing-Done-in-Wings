...
public class Reg_To_UnReg_PurchaseVoucher_IntraState_GST_TCS_Exclusive extends Transaction {
    ...
    public Reg_To_UnReg_PurchaseVoucher_IntraState_GST_TCS_Exclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
