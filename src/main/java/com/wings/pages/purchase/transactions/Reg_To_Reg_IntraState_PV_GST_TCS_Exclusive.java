...
public class Reg_To_Reg_IntraState_PV_GST_TCS_Exclusive extends Transaction {
    ...
    public Reg_To_Reg_IntraState_PV_GST_TCS_Exclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
