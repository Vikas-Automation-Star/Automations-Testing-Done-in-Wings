...
public class Reg_PRWIR_Interstate_RCMGST_TCS_InclusivePrice extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public Reg_PRWIR_Interstate_RCMGST_TCS_InclusivePrice(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
