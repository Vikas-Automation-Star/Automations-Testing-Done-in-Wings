...
public class PurchaseVoucher_UnRegInterRCMExclusive extends Transaction {
    ...
    public PurchaseVoucher_UnRegInterRCMExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String purchaseVoucher_UnRegInterRCMExclusive() throws InterruptedException, IOException, ParseException, AWTException {
...
//        deleteSingleTransaction(newVoucherID);
    ...
    public void addProduct(int i) throws InterruptedException, IOException, ParseException, AWTException {
        ...
        if (gstTransType.equalsIgnoreCase("Intra State Purchase from Unregistered Dealers")) {
        ...
        } else if (gstTransType.equalsIgnoreCase("Inter State Purchase from Unregistered Dealers")){
            ...
            String actualGSTAmount = common.findWebElement("xpath", "//Edit[@Name='GST RCM Amount Row "+i+", Not sorted.']").getText().replace(",", "");
            System.out.println("Actual GST Amount: " +actualGSTAmount);
            Assert.assertEquals(actualGSTAmount,common.getData(dataFile,"Purchase Voucher","expectedRCMGST"));
        }
        else {
            System.out.println("Gst TransactionType Mismatch");
        }
        String netAmountText = common.findWebElement("xpath", "//Edit[@Name='Net Amount Row " + i + ", Not sorted.']").getText().replace(",", "");
        System.out.println("Net Amount:- " + netAmount);
        Assert.assertEquals(netAmountText,common.getData(dataFile,"Purchase Voucher","netExpected"), "check calculations once");
