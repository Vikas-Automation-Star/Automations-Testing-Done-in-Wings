...
public class PVAPO_RegInterRCMGSTInclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean RCMgstAmountClicked=false;
    public PVAPO_RegInterRCMGSTInclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void reg_Inter_PVAO_Inclusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
