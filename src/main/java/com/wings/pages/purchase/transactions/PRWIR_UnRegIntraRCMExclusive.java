...
public class PRWIR_UnRegIntraRCMExclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public PRWIR_UnRegIntraRCMExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void prwir_UnRegIntraRCMExclusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
