...
//        enterAmountSalesPrice(dataFile, "GeneralInformation", "Amount");
        ...
        FileUtil.writeTimeLogInMinutes("Purchase Price General Information End:- ", generalInfoEndTime);

        long addProductStart = System.nanoTime();
        addProduct();
        long addProductEnd = System.nanoTime() - addProductStart;
        FileUtil.writeTimeLogInMinutes("Purchase Price Items:- ", addProductEnd);
