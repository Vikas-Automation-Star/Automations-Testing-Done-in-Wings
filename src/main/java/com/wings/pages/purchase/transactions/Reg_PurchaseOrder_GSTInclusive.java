...
public class Reg_PurchaseOrder_GSTInclusive extends Transaction { WindowsDriver driver;
    Common common;
    String dataFile;
    boolean gstAmountClicked = false;

    public Reg_PurchaseOrder_GSTInclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
