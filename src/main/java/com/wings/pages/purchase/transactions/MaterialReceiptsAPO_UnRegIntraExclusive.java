...
public class MaterialReceiptsAPO_UnRegIntraExclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public MaterialReceiptsAPO_UnRegIntraExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String[] unReg_MRAO_ExclusiveGST(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
