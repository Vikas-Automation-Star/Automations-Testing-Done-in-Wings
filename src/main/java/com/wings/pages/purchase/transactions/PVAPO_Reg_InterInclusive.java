...
public class PVAPO_Reg_InterInclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean gstAmountClicked=false;
    public PVAPO_Reg_InterInclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String[] pvopo_Reg_InterInclusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
        navigateToMastersWhen3Steps(common.getData(dataFile,"PVAPO GSTTCS","menu"),common.getData(dataFile,"PVAPO GSTTCS","menuItem"), common.getData(dataFile,"PVAPO GSTTCS","subMenuItem"));
        Thread.sleep(1000);
        ...
        gstTransactionType("Inter State Purchase from Registered Dealers");
        Thread.sleep(1000);
        selectPendingsSalesOrder(voucherNum,common.getData(dataFile,"PVAPO GSTTCS","FYear"));
        enterInput("xpath","//Edit[@Name='Purchase A/C Code']",dataFile,"PVAPO GSTTCS","purchaseA/cCode");
        enableCheckboxSelection("//CheckBox[@Name='Apply TCS']");
        enterInput("xpath","//Edit[@Name='TCS Trans Nature']", dataFile,"PVAPO GSTTCS","tcsNature");
        ...
        enterInput("xpath","//Edit[@Name='Batch Policy']",dataFile,"PVAPO GSTTCS","batchPolicy");
            ...
            for (String productCode : productCodes) {
                if (value != null && value.contains(productCode) && !processedCodes.contains(productCode)) {
                    if (processedCodes.isEmpty()) {
                        ...
                        serialNumberForMRAO(dataFile,"PVAPO GSTTCS","serialText","serialQuantity","");
                    }
        ...
        OtherChargesCalculations(dataFile,"PVAPO GSTTCS", "otherChargesCode", "amount", "rowCount","HSNCode","TaxType");
