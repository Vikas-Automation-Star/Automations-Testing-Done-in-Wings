...
public class PVAPO_UnRegInterInclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean gstAmountClicked=false;
    public PVAPO_UnRegInterInclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void pvapo_UnRegInterInclusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
        ...
        selectPendingsSalesOrder(voucherNum,common.getData(dataFile,"PVAPO UnRegInter","FYear"));
        enterInput("xpath","//Edit[@Name='Purchase A/C Code']",dataFile,"PVAPO UnRegInter","purchaseA/cCode");
        enableCheckboxSelection("//CheckBox[@Name='Apply TCS']");
        enterInput("xpath","//Edit[@Name='TCS Trans Nature']", dataFile,"PVAPO UnRegInter","tcsNature");
        inputTextWithValidation("xpath", "//Edit[@Name='Supplier Bill No *']", common.getData(dataFile,"PVAPO UnRegInter", "supplierCode") +common.getRandom());
        inputTextWithValidation("xpath", "//Edit[@Name='Supplier Bill Date *']", common.getData(dataFile,"PVAPO UnRegInter", "date") + Time.timeStamp());
        enterInput("xpath","//Edit[@Name='Batch Policy']",dataFile,"PVAPO UnRegInter","batchPolicy");
            ...
            for (String productCode : productCodes) {
                if (value != null && value.contains(productCode) && !processedCodes.contains(productCode)) {
                    if (processedCodes.isEmpty()) {
                        ...
                        serialNumberForMRAO(dataFile,"PVAPO UnRegInter","serialText","serialQuantity","");
                    }
        ...
        UnRegOtherChargesCalculations(dataFile,"PVAPO UnRegInter", "otherChargesCode", "amount", "rowCount","HSNCode","TaxType","expectedTaxibleValue","expectedGSTValue","expectedNetAmountValue");
