...
public class PurchaseOrdersAgainstQuotation extends TransactionsBaseClass {
...
//            common.sliderHandling("xpath", "//Table[@Name='Items']/*/Thumb[@Name='Position']",470, 0);
    ...
    public void addPostDatedCheques() throws IOException {
        ...
        List<WebElement> chequeETF = common.findWebElements("xpath", "//Table[@Name='PostDatedCheques']/*[contains(@Name,'Row ')]/Edit[starts-with(@Name,'Cheque/EFT No * Row ')]");
        ...
        for (int i = 0; i < postDatedCheques.size() ; i++) {
            ...
            enterListData(chequeETF.get(i), dataFile, "PostDatedCheques", "ChequeNo" ,i);
