...
public class PurchaseOrder_RegIntraExclusive extends Transaction {
    ...
    public PurchaseOrder_RegIntraExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String []reg_PV_GSTExclusive() throws InterruptedException, IOException, ParseException {
