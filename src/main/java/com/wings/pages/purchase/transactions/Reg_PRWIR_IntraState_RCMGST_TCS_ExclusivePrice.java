...
public class Reg_PRWIR_IntraState_RCMGST_TCS_ExclusivePrice extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public Reg_PRWIR_IntraState_RCMGST_TCS_ExclusivePrice(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void regPrwirExcusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
