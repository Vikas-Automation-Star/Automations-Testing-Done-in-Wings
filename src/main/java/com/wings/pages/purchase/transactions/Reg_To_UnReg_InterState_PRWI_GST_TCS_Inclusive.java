...
public class Reg_To_UnReg_InterState_PRWI_GST_TCS_Inclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;

    public Reg_To_UnReg_InterState_PRWI_GST_TCS_Inclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
