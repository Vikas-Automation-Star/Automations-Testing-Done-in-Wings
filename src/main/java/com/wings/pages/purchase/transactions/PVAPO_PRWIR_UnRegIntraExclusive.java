...
public class PVAPO_PRWIR_UnRegIntraExclusive extends Transaction {

    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean gstAmountClicked=false;
    public PVAPO_PRWIR_UnRegIntraExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void pvapo_PRWIR_UnRegIntraExclusive(String voucherNum) throws InterruptedException, IOException, ParseException {
        navigateToMastersWhen3Steps(common.getData(dataFile,"PVAPO_PRWIR UNRegIntra","menu"),common.getData(dataFile,"PVAPO_PRWIR UNRegIntra","menuItem"), common.getData(dataFile,"PVAPO_PRWIR UNRegIntra","subMenuItem"));
        Thread.sleep(1000);
        ...
        enterInput("xpath","//Edit[@Name='Purchase Return A/c Code']",dataFile,"PVAPO_PRWIR UNRegIntra","purchaseReturnActCode");
        enableCheckboxSelection("//CheckBox[@Name='Apply TCS']");
        enterInput("xpath","//Edit[@Name='TCS Trans Nature']", dataFile,"PVAPO_PRWIR UNRegIntra","tcsNature");
        ...
        Thread.sleep(1500);
        verifyReport(newVoucherID,dataFile,"PVAPO_PRWIR UNRegIntra");
