...
public class PurchaseOrder_RegInterInclusive extends Transaction {
    ...
    public PurchaseOrder_RegInterInclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public String[] Reg_PO_GSTInclusive() throws InterruptedException, IOException, ParseException {
...
//        deleteSingleTransaction(newVoucherID);
    ...
    public void addProduct(int i) throws IOException, ParseException {
        ...
        if (gstTransType.equalsIgnoreCase("Inter State Purchase from Registered Dealers")) {
            ...
            Assert.assertEquals(actualIGST, common.getData(dataFile,"Purchase Order", "igstAmount"));
            ...
            Assert.assertEquals(actualCESS, common.getData(dataFile,"Purchase Order", "cessAmountInclusive"));
            ...
            Assert.assertEquals(actualGSTAmount, common.getData(dataFile, "Purchase Order","expectedGStInclusive"), "calculations mismatch");
            ...
            Assert.assertEquals(actualCGST, common.getData(dataFile,"Purchase Order", "sgstAmount"));
            ...
            Assert.assertEquals(actualSGST, common.getData(dataFile,"Purchase Order", "cgstAmount"));

            String actualCESS = common.findWebElement("xpath", "//Edit[@Name='CESS Row " + i + ", Not sorted.']").getText();
            System.out.println("Actual CESS: " + actualCESS);
            Assert.assertEquals(actualCESS, common.getData(dataFile, "Purchase Order","cessAmountExclusive"));
            String actualGSTAmount = common.findWebElement("xpath", "//Edit[@Name='GST Amount Row " + i + ", Not sorted.']").getText();
            Assert.assertEquals(actualGSTAmount, common.getData(dataFile, "Purchase Order","expectedGStExclusive"));
        } else {
