...
public class PVOPO_Reg_IntraExclusive extends Transaction {
    WindowsDriver driver;
    Common common;
    String dataFile;
    boolean gstAmountClicked=false;
    public PVOPO_Reg_IntraExclusive(WindowsDriver driver, String file) {
        super(driver);
        this.driver = driver;
    ...
    public void pvopo_Reg_IntraExclusive(String voucherNum) throws InterruptedException, IOException, ParseException, AWTException {
