...
public class MaterialReceipt extends TransactionsBaseClass {
    ...
    public String materialReceipt(String tempAPIBodyUpdate,String apiResponse,String outputFile) throws Exception {
        ...
        FileUtil.writeTimeLogInMinutes("Material Receipt General information End:- ", generalInfoEndTime);
...
//        addAllocations();
    ...
    public void addProduct() throws Exception {
        ...
        List<WebElement> grossAmount = common.findWebElements("xpath", "//Table[@Name='Items']/*[contains(@Name,'Row ')]/Edit[contains(@Name,'Gross Amount Row ')]");
