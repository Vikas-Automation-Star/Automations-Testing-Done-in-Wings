...
public class CopyACompany {
    ...
    public static void copyCompany() throws MalformedURLException, InterruptedException {
        ...
        WebElement doubleClick = driver.findElementByXPath("//ListItem[@Name='restore']");
        ...
        driver.findElementByXPath("//TreeItem[@Name='New Volume (E:)']").click();
        WebElement doubleClick1 = driver.findElementByXPath("//ListItem[@Name='backup']");
        Actions actions1 = new Actions(driver);
        actions1.doubleClick(doubleClick1).perform();
//        WebElement doubleClick2=driver.findElementByXPath("//ListItem[@Name='backup']");
//        Actions actions2 =new Actions(driver);
//        actions1.doubleClick(doubleClick2).perform();
        driver.findElementByXPath("//Button[@Name='Select Folder']").click();
        driver.findElementByXPath("//Button[@Name='Next >']").click();
