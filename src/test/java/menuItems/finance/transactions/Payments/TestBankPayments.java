...
public class TestBankPayments {
    ...
    String purchaseFile = "./src/main/resources/menuItems/purchase/transactions/479081 - Purchase Vouchers-AC_PV_9.xls";
...
//        String voucherNum=purchaseVoucher.purchaseVoucher(TEMP_API_BODY_PURCHASE_VOUCHERS,API_RESPONSE_PURCHASE_VOUCHERS,OUTPUT_FILE);
//
//        appLogin.logout();
//        driver=appLogin.login();
