...
import com.wings.pages.purchase.transactions.PVAMR_UnRegIntraExclusive;
...
public class TestPVAMR_UnRegIntraExclusivePrice {
    ...
    public void UnReg_PO_MRAPO_ExclusivePrice() throws IOException, ParseException, InterruptedException, NoSuchMethodException, AWTException {
        ...
        String [] MRExclusive=receipts.unReg_MRAO_ExclusiveGST(unRegExc[1]);
        PVAMR_UnRegIntraExclusive UnRegExclusive =new PVAMR_UnRegIntraExclusive(driver,file);
        UnRegExclusive.pvamr_UnRegIntraExclusive(MRExclusive[1]);
    }
