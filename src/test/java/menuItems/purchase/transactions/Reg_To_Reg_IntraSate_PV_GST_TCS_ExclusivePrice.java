...
public class Reg_To_Reg_IntraSate_PV_GST_TCS_ExclusivePrice {
    ...
    public void Reg_To_Reg_IntraState_PurchaseVoucher_GST_TCS_Exclusive() throws IOException, ParseException, InterruptedException, AWTException {
        Reg_To_Reg_IntraState_PV_GST_TCS_Exclusive voucher=new Reg_To_Reg_IntraState_PV_GST_TCS_Exclusive(driver,dataFile);
