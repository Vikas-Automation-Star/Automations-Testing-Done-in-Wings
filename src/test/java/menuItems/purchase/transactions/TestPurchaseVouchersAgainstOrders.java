...
public class TestPurchaseVouchersAgainstOrders {
    ...
    public void purchaseVouchersAgainstOrders() throws Exception {
        ...
        String enquiresVoucher=purchaseEnquiries.purchaseEnquires(TEMP_API_BODY_PURCHASE_ENQUIRY,API_RESPONSE_PURCHASE_ENQUIRY,OUTPUT_FILE1);
        ...
        String ordersAgainstQuotationVoucher= ordersAgainstQuotation.purchaseOrdersAgainstQuotation(quotationsAgainstEnquiryVoucher,TEMP_API_BODY_PURCHASE_ORDERS_AGAINST_QUOTATIONS,API_RESPONSE_PURCHASE_ORDERS_AGAINST_QUOTATIONS,OUTPUT_FILE3);

        appLogin.logout();
        driver= appLogin.login();

        PurchaseVouchersAgainstOrder vouchersAgainstOrder = new PurchaseVouchersAgainstOrder(driver, dataFile3);
        String PurchaseVouchersAgainstOrderVoucher=vouchersAgainstOrder.purchaseVouchersAgainstOrder(ordersAgainstQuotationVoucher,TEMP_API_BODY_PURCHASE_VOUCHERS_AGAINST_ORDERS,API_RESPONSE_PURCHASE_VOUCHERS_AGAINST_ORDERS,OUTPUT_FILE4);
