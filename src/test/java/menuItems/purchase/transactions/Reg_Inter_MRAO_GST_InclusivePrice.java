...
import com.wings.pages.purchase.transactions.Reg_Inter_MRAO_InclusiveGST;
...
public class Reg_Inter_MRAO_GST_InclusivePrice {
    ...
    public void reg_PurchaseOrder_GST_InclusivePrice() throws IOException, ParseException, InterruptedException, AWTException {
        ...
        Reg_Inter_MRAO_InclusiveGST mrao=new Reg_Inter_MRAO_InclusiveGST(driver,file);
        mrao.mroa_InclusiveGST();
    }
