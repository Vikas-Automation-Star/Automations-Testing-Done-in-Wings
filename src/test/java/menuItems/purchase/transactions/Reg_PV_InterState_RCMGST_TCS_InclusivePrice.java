...
import com.wings.pages.purchase.transactions.UnReg_PV_InterState_RCMGST_TCS_Inclusive;
...
public class Reg_PV_InterState_RCMGST_TCS_InclusivePrice {
    ...
    public void reg_InterState_PV_RCMGST_TCS_Inclusive() throws IOException, ParseException, InterruptedException, AWTException {
        UnReg_PV_InterState_RCMGST_TCS_Inclusive inclusiveRCM=new UnReg_PV_InterState_RCMGST_TCS_Inclusive(driver,dataFile);
