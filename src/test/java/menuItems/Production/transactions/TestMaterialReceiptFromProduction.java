...
public class TestMaterialReceiptFromProduction {
    ...
    private static final String OUTPUT_FILE1="./src/main/resources/menuItems/production/transactions/475297 - Material Receipts from Production-AC_MRFP_1_Output.xls";

    String file = "./src/main/resources/menuItems/production/transactions/475293 - Production Orders-AC_PRO_1.xls";
    String file1 = "./src/main/resources/menuItems/production/transactions/475297 - Material Receipts from Production-AC_MRFP_1.xls";
...
//        driver= appLogin.login();
        ...
        com.wings.pages.production.transactions.MaterialReceiptFromProduction mrfp = new com.wings.pages.production.transactions.MaterialReceiptFromProduction(driver, file1);
        mrfp.materialReceiptFromProduction("PRO 2",TEMP_API_BODY_MATERIAL_RECEIPTS_FROM_PRODUCTION,API_RESPONSE_MATERIAL_RECEIPTS_FROM_PRODUCTION,OUTPUT_FILE1);
    }
