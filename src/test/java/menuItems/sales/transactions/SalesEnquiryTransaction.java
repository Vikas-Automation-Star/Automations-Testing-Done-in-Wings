...
public class SalesEnquiryTransaction {
    ...
    String file = "./src/main/resources/menuItems/purchase/transactions/salesDemo.json";
...
//        sales.salesEnquiry();
        SalesEnquiriesDemo salesEnquiriesDemo = new SalesEnquiriesDemo(driver,file);
        salesEnquiriesDemo.salesEnquiresDemo();
    }
