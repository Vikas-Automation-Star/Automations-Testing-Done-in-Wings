...
public class TestSIFQ_UnRegInterInclusive {
        WindowsDriver driver;
        AppLogin appLogin=new AppLogin();
        String dataFile="./src/main/resources/menuItems/Sales/Transactions/SalesInvoiceFQ_UnRegInterInclusive.json";
        ...
        public void InclusiveTCSGSTFreeQuantity() throws IOException, ParseException, InterruptedException, AWTException {
            ...
            unRegInterInclusiveTCSGSTFreeQty.interStateInclusiveTCSGST_FreeQty();
        }
