...
public class TestSalesQuotationsCancellation {
    private static final Logger log = LoggerFactory.getLogger(TestSalesQuotationsCancellation.class);
    ...
    private static final String OUTPUT_FILE_QUOTATIONS="./src/main/resources/menuItems/Sales/Transactions/460553 - Sales Quotations-AC_SQ_35_Output.xls";
