...
public class TestDeliveriesAgainstOrder_UnRegInterInclusive {
        ...
        @Test
        public void delo_UnRegInterInclusive() throws IOException, ParseException, InterruptedException, AWTException {
            ...
            againstOrdersUnRegInterInclusive.interInclusiveUnRegDeliveries(salesOrder[1]);
//            againstOrdersUnRegInterInclusive.interInclusiveUnRegDeliveries("SO 14");
