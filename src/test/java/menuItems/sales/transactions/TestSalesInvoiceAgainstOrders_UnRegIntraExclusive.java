...
import com.wings.pages.sales.transactions.SalesInvoiceAgainstOrders_UnRegIntraExclusive;
...
public class TestSalesInvoiceAgainstOrders_UnRegIntraExclusive {
        ...
        public void siad_UnRegIntraExclusive() throws IOException, ParseException, InterruptedException, AWTException {
            ...
            SalesInvoiceAgainstOrders_UnRegIntraExclusive ordersUnRegIntraExclusive=new SalesInvoiceAgainstOrders_UnRegIntraExclusive(driver,dataFile);
            ordersUnRegIntraExclusive.intraExclusiveUnregSIAO(salesOrder[1]);
//            ordersUnRegIntraExclusive.intraExclusiveUnregSIAO(unRegIntraExclusive.intraExclusiveUnReg()[1]);
