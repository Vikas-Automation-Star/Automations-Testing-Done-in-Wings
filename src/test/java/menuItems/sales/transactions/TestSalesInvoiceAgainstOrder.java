...
public class TestSalesInvoiceAgainstOrder {
    ...
    private static final String OUTPUT_FILE_SALES_INVOICE_AGAINST_ORDER="./src/main/resources/menuItems/Sales/Transactions/480461 - Sales Invoices against Orders-AC_Output.xls";
